                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">افزودن موسسه از اکسل
                                    </li>
                                </ol>
                                @if (session('success'))
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card px-2">
                                ...
                                <div class="col-md-6">
                                    <form action="{{ route('institutes.rollback') }}" method="post" class="mt-4">
                                        @csrf
                                        <button type="submit" class="btn btn-warning">بازگردانی آخرین آپلود</button>
                                    </form>
                                </div>
                                <form action="{{ route('institutes.upload') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                            ...
                                            <fieldset class="form-group">
                                                <p>
                                                    ...
                                                    @if(auth()->user()->can('one user'))
                                                        <a href="{{ asset('public/upload/example-supporter2.xlsx') }}">دریافت فایل example.xlsx</a>
                                                    @else
                                                        <a href="{{ asset('public/upload/example-manager2.xlsx') }}">دریافت فایل example.xlsx</a>
                                                    @endif
                                                </p>
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                ...
                                                <label class="w-100 alert-success">
                                                    <input type="radio" class="radio" name="error" checked id="error" value="notSetAll"/> عدم ثبت مشخصات همه‌ی موسسه در صورت وجود خطا
                                                </label>
                                                <label class="w-100 alert-warning">
                                                    <input type="radio" class="radio" name="error" @if(old('error' == 'notSetStu')) checked @endif id="error" value="notSetStu"/> عدم ثبت مشخصات موسسه دارای خطا
                                                </label>
