                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <select style="width: 100%;margin-right: 0" name="role" id="role" class="select2 form-control">
                                                    ...
                                                    @foreach ($roles as $role)
                                                        <option value="{{ $role->name }}" @if(isset($userRole[0]) and $userRole[0] == $role->name) selected="selected" @endif>{{ $role->name }}</option>
                                                    @endforeach
                                                </select>
                                            </fieldset>
                                        </div>
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <select style="width: 100%;margin-right: 0" name="country_id" id="country" class="select2 form-control">
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option @if($country->id == $user->country_id) selected="selected" @endif value="{{ $user->country_id }}">{{ $country->title }} - {{ $country->symbol }}</option>
                                                    @endforeach
                                                </select>
                                            </fieldset>
                                        </div>
