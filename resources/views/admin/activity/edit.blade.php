            ...
            <div class="content-body">
                ...
                <section id="basic-input">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card px-2">
                                <form enctype="multipart/form-data" method="post" action="{{ route('activities.update',$activity->id) }}">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                ...
                                                <select style="width: 300px;" dir="rtl" name="student_id" id="student_id" class="select2 form-control activity-select">
                                                    ...
                                                    <option selected="selected" value="{{ $activity->student_id }}">{{ $student->text }}</option>
                                                </select>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" id="description" rows="3" placeholder="">{{ $activity->description }}</textarea>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                <label for="studentComment"> نظر دانشجو </label>
                                                <textarea class="form-control" name="studentComment" id="studentComment" rows="3" placeholder="">{{ $activity->studentComment }}</textarea>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                <label for="startTS"> تاریخ شروع </label>
                                                <input type="text" name="startTS" id="startTS" value="{{ \Morilog\Jalali\Jalalian::forge($activity->startTS)->format('Y/m/d H:i:s') }}" class="form-control">
                                                <script>
                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="endTS" id="endTS" value="{{ \Morilog\Jalali\Jalalian::forge($activity->endTS)->format('Y/m/d H:i:s') }}" class="form-control">
                                                <script>
                                        ...
                                        <div class="col-md-12">
                                            <fieldset class="form-group">
                                                ...
                                                <textarea class="form-control" name="report" id="report" rows="3" placeholder="">{{ $activity->report }}</textarea>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <select name="actionState_s" id="actionState_s" class="custom-select">
                                                    ...
                                                    @foreach ($settings['actionState'] as $setting)
                                                        <option @if($setting == $activity->state_s) selected="selected" @endif value="{{ $setting }}">{{ $setting }}</option>
                                                    @endforeach
                                                </select>
                                            </fieldset>
                                        </div>
