                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="fatherName" id="fatherName" value="{{ $student->fatherName }}" class="form-control" required>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="birthDate" id="birthDate" value="{{ $student->birthDate }}" placeholder="اگر وارد نشود زمان حال ثبت می‌شود" class="form-control">
                                                <script>
                                                    var objCal1 = new AMIB.persianCalendar( 'birthDate' );
                                                </script>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                <label for="commissionAttraction"> نوع کمیسیون </label>
                                                <label>جذب موسسه
                                                    <input @if($student->commissionAttraction == 1) checked @endif type="radio" name="commissionAttraction" value="1">
                                                </label>
                                                &nbsp;&nbsp;&nbsp;
                                                <label>جذب مربی
                                                    <input @if($student->commissionAttraction == 0) checked @endif type="radio" name="commissionAttraction" value="0">
                                                </label>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6">
