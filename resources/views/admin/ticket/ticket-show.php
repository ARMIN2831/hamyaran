                    ...
                    <span class="dropdown">
                        ...
                        if ($tkt->active){
                            ...
                            <span class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="'.baseDir.'/ticket/'.$ticketID.'/close/"><i class="bx bx-trash mr-25"></i> بستن تیکت</a>
                            </span>
                            ';
                        }
                        if (@$uri[3][0] == "close"){
                ...
                <div class="card-body chat-container">
                    <div class="chat-content">
                        ...
                        if ($post['text']){ //ارسال پیام
                            ...
                            redirect("ticket/".$ticketID."/#end_chat");
                        }
